...
Publications
======
My publications are also listed on the [Publications](publications/) page and on my [Google Scholar profile](https://scholar.google.com/citations?hl=en&user=tbK9jl4AAAAJ&view_op=list_works&sortby=pubdate). **Junteng Liu** is shown in bold.
...
2. **On the Perception Bottleneck of VLMs for Chart Understanding** — Arxiv, 2025. *(First author)* [Code](https://github.com/Vicent0205/Vision4Chart)  
   **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He
3. **On the Universal Truthfulness Hyperplane Inside LLMs** — EMNLP 2024. *(First author)* [Code](https://github.com/Vicent0205/Universal_Truthfulness_Hyperplane)  
...
- Vision-Language Models (VLMs), Hallucination Mitigation
- LLM Truthfulness, Model Interpretability
